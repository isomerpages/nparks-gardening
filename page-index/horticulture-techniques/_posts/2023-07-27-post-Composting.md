...
<p>Because of the mixing and continuous adding of materials, mature and immature compost will be mixed in your bin with larger materials that have not decomposed. Mature compost tends to settle at the bottom of a bin, so some gardeners will flip the entire bin or pile and dig out mature compost to use. Mature compost can also be filtered out from immature compost by using a screen. The final product should feel soft and fine with a pleasant, earthy smell. If the compost feels chunky and has an acidic, unpleasant smell, it is not ready for use. </p>
